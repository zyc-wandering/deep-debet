      ...
      <header className="config-header">
        <div className="config-header-copy">
          ...
          <p className="config-intro">
            先设定辩题、强度和轮次。主持人会优先调研并确定讨论框架，再把辩手送上同一张
          ...
          <section className="config-form-main">
            ...
            <div className="form-section">
              <div className="section-kicker">
                ...
                <div>
                  <h2>调整运行参数</h2>
                  <p>在主持人正式开始前，先平衡辩手数量、交锋轮次和模型档位。辩论时长固定为 30 分钟上限。</p>
                </div>
              </div>
          ...
          <aside className="config-form-side">
            <div className="config-summary-card">
              ...
              <div className="summary-stat-grid">
                ...
                <article>
                  <span>时长</span>
                  <strong>{Math.floor(timeLimitSec / 60)} 分钟</strong>
                </article>
                <article>
                  <span>轮次</span>
              ...
              <div className="config-note">
                ...
                <p>
                  计时会在辩手就位后才开始，且整场辩论固定为 30 分钟上限。前面的准备窗口会留给主持人完成调研、定调和组局。
                </p>
              </div>
